...
class SenditempageWidget extends StatefulWidget {
  const SenditempageWidget({
    Key? key,
    this.kuehname,
  }) : super(key: key);
  ...
  @override
  _SenditempageWidgetState createState() => _SenditempageWidgetState();
}

class _SenditempageWidgetState extends State<SenditempageWidget> {
  ...
  TextEditingController? textField11Controller;
  ...
  void initState() {
    ...
    textField7Controller = TextEditingController();
    textField8Controller = TextEditingController();
    textField9Controller = TextEditingController();
    textField10Controller = TextEditingController();
    textField11Controller = TextEditingController();
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        final sendItemSumarryCreateData =
                                            createSendItemSumarryRecordData(
                                          kuehName: widget.kuehname,
                                          shop1: int.tryParse(
                                          ...
                                          shop11: int.tryParse(
                                              textField7Controller!.text),
                                          shop12: int.tryParse(
                                              textField8Controller!.text),
                                          shop13: int.tryParse(
                                              textField9Controller!.text),
                                          shop14: int.tryParse(
                                              textField10Controller!.text),
                                          shop15: int.tryParse(
                                              textField11Controller!.text),
                                          delivery: checkboxListTileCheckedItems
                                              .toString(),
                                        );
                                        await SendItemSumarryRecord.collection
                                            .doc()
                                            .set(sendItemSumarryCreateData);
                                        context.pop();
                                      },
                                      text: 'Confirm',
                          ...
                          child: Padding(
                            ...
                            child: StreamBuilder<List<DeliveryRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<DeliveryRecord>
                                    checkboxListTileDeliveryRecordList =
                                    snapshot.data!;
                                return Theme(
                                  data: ThemeData(
