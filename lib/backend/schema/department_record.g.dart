...
class _$DepartmentRecord extends DepartmentRecord {
  ...
  _$DepartmentRecord._({this.departmentName, this.ffRef}) : super._();
  ...
  @override
  int get hashCode {
    return $jf($jc($jc(0, departmentName.hashCode), ffRef.hashCode));
  }
...
class DepartmentRecordBuilder
  ...
  _$DepartmentRecord _build() {
    final _$result = _$v ??
        new _$DepartmentRecord._(departmentName: departmentName, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
